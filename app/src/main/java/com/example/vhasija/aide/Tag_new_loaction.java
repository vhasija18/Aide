...
public class Tag_new_loaction extends FragmentActivity implements OnMapReadyCallback,
...

    {
        ...
        setContentView(R.layout.activity_tag_new_loaction);
    ...
    public void savelocation(View view)
    {
        ...
        String url = "http://192.168.2.34:8089/aide/changepassword.php?RequestType=tag&lati="+latitude+"&longi="+longitude+"&id="+id;
    ...
    public void checkresult(String s)
    {
        ...
        {
            Toast.makeText(this, "Location has been updated", Toast.LENGTH_LONG).show();
            finish();
        }
        else
        {
